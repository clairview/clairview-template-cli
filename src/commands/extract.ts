...
export default class ExtractCommand extends Command {
  static description = 'Extract a template from a Clairview instance.'

  static examples = ['$ clairview-template-cli extract']
  ...
  public async run(): Promise<void> {
    ...
    ux.action.start(
      `Extracting template - from ${clairviewUrl} to ${directory}`,
    )
