import {createCollection, createField, updateCollection} from '@clairview/sdk'
...
/**
 * Load collections into the Clairview instance
 */
...
async function addCustomFieldsOnSystemCollections(fields: any[]) {
  const customFields = fields.filter(
    (field: any) => field.collection.startsWith('clairview_'),
  )
